2-4 Players | Age 13 and up | X-Y Minutes
# Objective

Team, your mission is critical, and the stakes are high. As you know, space debris has already caused significant damage to vital satellites, threatening communication, navigation, and weather systems critical for life on Earth. Your goal is twofold: clear these debris fields and repair damaged satellites. 
...
4. Each player, place the Space Ship HP Tracker token on their Space Ship card under the 4 HP mark  
...
- If it is an orbit card...
	...
	- Add Debris Cubes from the supply to that space 1 at a time
	- If the space contains 3 Debris Cubes and you must place additional Debris Cubes in that space a <i>collision</i> has occurred. See the collision section below.
...
- All Satellite cards are flipped to their repaired side
## Defeat
